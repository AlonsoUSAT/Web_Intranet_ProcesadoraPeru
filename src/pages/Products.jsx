  ...
  return (
    <>
      ...
      <div className="w-full bg-[#FAFAFA] min-h-screen pt-24 pb-16 font-body">
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-12 mb-12 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="relative group min-w-[280px]">
            <div className="absolute inset-y-0 left-4 flex items-center pointer-events-none">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#954500" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
            </div>
            <select
              value={selectedProductId}
              onChange={(e) => setSelectedProductId(e.target.value)}
              className="w-full appearance-none bg-white border border-[#E4E4E7] text-[#1B1C1C] font-semibold text-sm rounded-full py-3 pl-12 pr-10 outline-none transition-all focus:border-[#954500] focus:ring-1 focus:ring-[#954500] shadow-sm cursor-pointer"
            >
            ...
            <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#71717A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"></polyline></svg>
            </div>
          </div>
        </div>
        ...
        {!isLoading && showcaseProduct && (
          <motion.div 
            ...
            className="max-w-[1280px] mx-auto px-6 md:px-12 mb-24 flex flex-col gap-12"
          >
            {/* 1. Header Showcase */}
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              <div className="w-full lg:w-3/5 relative">
                <div 
                  className="w-full h-[400px] md:h-[500px] bg-white rounded-xl shadow-sm bg-cover bg-center"
                  style={{ backgroundImage: `url('${productImages[showcaseProduct.id] || showcaseProduct.image}')` }}
                />
                {/* Export Grade Quality Badge */}
                <div className="absolute -bottom-6 right-8 md:-right-6 bg-[#AEF27A] rounded-lg shadow-lg p-6 w-[160px] transform rotate-3">
                  ...
                  <span className="text-[#377000] font-heading font-bold text-sm leading-tight block">
              ...
              <div className="w-full lg:w-2/5 flex flex-col justify-center">
                <div className="bg-[#AEF27A] text-[#377000] font-body text-xs font-bold px-3 py-1 rounded-sm w-fit uppercase tracking-wider mb-6">
                  PREMIUM HARVEST
                </div>
                <h1 className="text-[#1B1C1C] font-heading text-[48px] md:text-[56px] font-extrabold leading-[1.1] mb-6 tracking-tight">
                  {showcaseProduct.name}
                </h1>
                <p className="text-[#554339] font-body text-lg leading-relaxed mb-8">
                ...
                {/* Pricing Card */}
                <div className="bg-[#F6F3F2] rounded-xl p-8 border border-[#E4E4E7]">
                  <div className="flex justify-between items-start mb-8">
                    <span className="text-[#71717A] font-body text-xs font-bold tracking-widest uppercase">Wholesale<br/>Pricing</span>
                    <div className="text-right">
                      <span className="text-[#954500] font-heading text-2xl font-extrabold block">Contact for Price</span>
                      <span className="text-[#71717A] font-body text-xs">FOB / CIF Available</span>
                    </div>
                  </div>

                  <div className="mb-6">
                    <span className="text-[#1B1C1C] font-body text-xs font-bold tracking-wider uppercase mb-3 block">Variety Selection</span>
                    <div className="grid grid-cols-2 gap-3">
                      <button className="border-2 border-[#954500] text-[#954500] font-bold py-2.5 rounded-sm bg-white">Kent</button>
                      <button className="border border-[#D4D4D8] text-[#52525B] font-semibold py-2.5 rounded-sm bg-white hover:border-[#954500]">Tommy Atkins</button>
                    </div>
                  </div>

                  <div className="mb-8">
                    <span className="text-[#1B1C1C] font-body text-xs font-bold tracking-wider uppercase mb-3 block">Quantity (Containers)</span>
                    <div className="flex items-center justify-between bg-white border border-[#D4D4D8] rounded-sm py-2 px-4">
                      <button className="text-[#954500] font-bold text-xl hover:scale-110 transition-transform">−</button>
                      <span className="font-heading font-bold text-lg">1</span>
                      <button className="text-[#954500] font-bold text-xl hover:scale-110 transition-transform">+</button>
                    </div>
                  </div>

                  <button className="w-full bg-[#954500] text-white font-bold py-4 rounded-sm flex justify-center items-center gap-2 hover:bg-[#7a3800] transition-colors shadow-md">
            ...
            <div className="bg-[#EBEBEB] rounded-2xl p-8 md:p-12 flex flex-col lg:flex-row gap-12">
              <div className="w-full lg:w-1/3">
                <h2 className="text-[#1B1C1C] font-heading text-[32px] font-extrabold mb-4">Technical Data Sheet</h2>
                <p className="text-[#554339] font-body text-sm leading-relaxed mb-8">
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex justify-between border-b border-[#D4D4D8] pb-3">
                    ...
                    <span className="text-[#554339] text-sm">Mangifera Indica</span>
                  </div>
                  <div className="flex justify-between border-b border-[#D4D4D8] pb-3">
                    <span className="font-bold text-[#1B1C1C] text-sm">Common Name</span>
                    <span className="text-[#554339] text-sm">Mango</span>
                  </div>
                  <div className="flex justify-between border-b border-[#D4D4D8] pb-3">
                    <span className="font-bold text-[#1B1C1C] text-sm">Color</span>
                    <span className="text-[#554339] text-sm">Deep Yellow/Red Gradient</span>
                  </div>
                  <div className="flex justify-between border-b border-[#D4D4D8] pb-3">
                    <span className="font-bold text-[#1B1C1C] text-sm">Brix Level</span>
                    <span className="text-[#554339] text-sm">14° - 18°</span>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-2/3 flex flex-col gap-6">
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="flex-1 bg-white rounded-xl p-8 shadow-sm">
                    ...
                    <ul className="text-sm text-[#554339] space-y-2">
                ...
                <div className="w-full bg-white rounded-xl p-8 shadow-sm">
                  ...
                  <p className="text-[10px] text-[#A1A1AA] mt-4 italic">* Peak harvest indicated in dark orange. Availability may vary by climatic conditions.</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 items-center pt-8">
              <div className="w-full lg:w-1/2">
                <h2 className="text-[#1B1C1C] font-heading text-[32px] md:text-[40px] font-extrabold leading-tight mb-6">
                  Industrial Precision Meets Organic Excellence
                </h2>
                <p className="text-[#554339] font-body text-base leading-relaxed mb-6">
                ...
                <p className="text-[#554339] font-body text-base leading-relaxed mb-10">
                ...
                <div className="flex gap-12">
                  <div>
                    <span className="text-[#377000] font-heading font-black text-3xl block mb-1">100%</span>
                    <span className="text-[#1B1C1C] font-body text-xs font-bold uppercase tracking-wider">Organic Certified</span>
                  </div>
                  <div>
                    <span className="text-[#377000] font-heading font-black text-3xl block mb-1">Global</span>
                    <span className="text-[#1B1C1C] font-body text-xs font-bold uppercase tracking-wider">GAP Compliant</span>
                  </div>
                </div>
              </div>
              <div className="w-full lg:w-1/2">
                <div 
                  className="w-full h-[350px] rounded-2xl bg-cover bg-center shadow-lg"
          ...
          {isLoading ? (
            ...
            <>
              <div className="flex items-center gap-4 mb-8">
                <h2 className="text-[#1B1C1C] font-heading text-2xl font-bold">Explorar Catálogo</h2>
                ...
                <AnimatePresence>
                  {filteredProducts.map((product) => (
                    <motion.div
                      ...
                      className="bg-white border border-[#E4E4E7] rounded-xl overflow-hidden group hover:shadow-xl transition-all cursor-pointer"
                      onClick={() => {
                    ...
                    >
                      ...
                      <div className="h-[240px] w-full overflow-hidden relative">
                        ...
                        />
                        <div className="absolute top-4 left-4 bg-white/90 backdrop-blur-sm text-[#1B1C1C] text-xs font-bold px-3 py-1 rounded-sm uppercase tracking-wider shadow-sm">
                          {product.category}
                        </div>
                      </div>
                      ...
                      {/* Content */}
                      <div className="p-6">
                        <h3 className="text-[#1B1C1C] font-heading text-xl font-bold mb-2 group-hover:text-[#954500] transition-colors">{product.name}</h3>
                        <p className="text-[#554339] font-body text-sm mb-4 line-clamp-2">
                          {product.description}
                        </p>
                        <div className="flex items-center gap-2 pt-4 border-t border-[#F4F4F5]">
                          ...
                          <span className="text-[#71717A] font-body text-xs font-semibold">{product.origin}</span>
                        </div>
                      </div>
                    </motion.div>
                  ))}
              ...
              {!isLoading && filteredProducts.length === 0 && (
                <div className="text-center py-24 bg-white rounded-xl border border-[#E4E4E7]">
                  <p className="text-[#71717A] text-lg font-body">No se encontraron productos con estos filtros.</p>
                  <button 
