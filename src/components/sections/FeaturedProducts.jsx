        ...
        >
          ...
          <div className="flex gap-8 md:gap-12 w-full md:w-auto">
            <div>
              ...
              <div className="text-[#71717A] font-body text-xs md:text-sm font-bold tracking-widest uppercase">{t.home.featStat1}</div>
            </div>
            <div>
              <div className="text-[#954500] font-heading text-3xl md:text-4xl font-black mb-1 md:mb-2">15k</div>
              <div className="text-[#71717A] font-body text-xs md:text-sm font-bold tracking-widest uppercase">{t.home.featStat2}</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:col-span-7 h-[350px] md:h-[480px] rounded-2xl overflow-hidden relative group">
            ...
            <div className="absolute bottom-0 left-0 p-6 md:p-10">
              <h3 className="text-white font-heading text-2xl md:text-3xl font-bold mb-2 md:mb-4">{t.home.prod1Title}</h3>
          ...
          <div className="md:col-span-5 flex flex-col gap-6">
            <motion.div variants={itemVariants} className="h-[200px] md:h-[260px] rounded-2xl overflow-hidden relative group">
              ...
              <div className="absolute bottom-0 left-0 p-6 md:p-8">
                <h3 className="text-white font-heading text-xl md:text-2xl font-bold mb-2">{t.home.prod2Title}</h3>
            ...
            <motion.div variants={itemVariants} className="min-h-[160px] md:h-[196px] rounded-2xl bg-[#E4E2E1] p-6 md:p-8 flex flex-col justify-between">
              ...
              <div>
                <h3 className="text-[#1B1C1C] font-heading text-xl md:text-2xl font-bold mb-2">{t.home.feat3Title}</h3>
